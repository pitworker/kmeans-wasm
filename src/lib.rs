...
mod tests {
  ...
  #[bench] fn complete_benchmark_lloyd_small_f64(b: &mut Bencher) {
    complete_benchmark_lloyd::<f64>(b, 200, 2000, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_mid_f64(b: &mut Bencher) {
    complete_benchmark_lloyd::<f64>(b, 2000, 200, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_big_f64(b: &mut Bencher) {
    complete_benchmark_lloyd::<f64>(b, 10000, 8, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_huge_f64(b: &mut Bencher) {
    complete_benchmark_lloyd::<f64>(b, 20000, 256, 1, 32);
  }
  #[bench] fn complete_benchmark_lloyd_small_f32(b: &mut Bencher) {
    complete_benchmark_lloyd::<f32>(b, 200, 2000, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_mid_f32(b: &mut Bencher) {
    complete_benchmark_lloyd::<f32>(b, 2000, 200, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_big_f32(b: &mut Bencher) {
    complete_benchmark_lloyd::<f32>(b, 10000, 8, 10, 32);
  }
  #[bench] fn complete_benchmark_lloyd_huge_f32(b: &mut Bencher) {
  ...
  #[bench] fn complete_benchmark_minibatch_small_f64(b: &mut Bencher) {
    complete_benchmark_minibatch::<f64>(b, 30, 200, 2000, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_mid_f64(b: &mut Bencher) {
    complete_benchmark_minibatch::<f64>(b, 200, 2000, 200, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_big_f64(b: &mut Bencher) {
    complete_benchmark_minibatch::<f64>(b, 1000, 10000, 8, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_huge_f64(b: &mut Bencher) {
    complete_benchmark_minibatch::<f64>(b, 2000, 20000, 256, 30, 32);
  }
  #[bench] fn complete_benchmark_minibatch_small_f32(b: &mut Bencher) {
    complete_benchmark_minibatch::<f32>(b, 30, 200, 2000, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_mid_f32(b: &mut Bencher) {
    complete_benchmark_minibatch::<f32>(b, 200, 2000, 200, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_big_f32(b: &mut Bencher) {
    complete_benchmark_minibatch::<f32>(b, 1000, 10000, 8, 100, 32);
  }
  #[bench] fn complete_benchmark_minibatch_huge_f32(b: &mut Bencher) {
